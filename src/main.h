...
public:
    ...
    {
        // Carincoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Carincoin: get transaction coin age
...
public:
    ...
    // Carincoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Carincoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Carincoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Carincoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Carincoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Carincoin: block index flags
    enum  
    {
