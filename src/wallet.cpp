...
// Carincoin: total coins staked (non-spendable until maturity)
...
// Carincoin: check 'spent' consistency between wallet and txindex
// Carincoin: fix wallet spent state according to txindex
...
// Carincoin: disable transaction (only for coinstake)
